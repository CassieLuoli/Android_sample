    ...
    public void initPresenter() {
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(CalendarView calendarView, int i, int i1, int i2) {
                weekView.goToDate(new GregorianCalendar(i, i1, i2));
            }
        });
        ...
        weekView.setMonthChangeListener(new MonthLoader.MonthChangeListener() {
            ...
            public List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) {
                return prepareWeekViewEvents(newYear, newMonth);
            }
        });
    }

    @NonNull
    private List<? extends WeekViewEvent> prepareWeekViewEvents(int newYear, int newMonth) {
        ...
        endTime.set(Calendar.MONTH, newMonth-1);
        event = new WeekViewEvent(10, "meeting", startTime, endTime);
        ...
        event = new WeekViewEvent(10, "SESSION", startTime, endTime);
        ...
        endTime.set(Calendar.MONTH, newMonth-1);
        event = new WeekViewEvent(2, "SESSION", startTime, endTime);
        ...
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(3, "SESSION", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_02));
        events.add(event);
        ...
        endTime = (Calendar) startTime.clone();
        endTime.add(Calendar.HOUR_OF_DAY, 3);
        event = new WeekViewEvent(4, "SESSION", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_01));
        events.add(event);
        ...
        endTime = (Calendar) startTime.clone();
        endTime.add(Calendar.HOUR_OF_DAY, 3);
        event = new WeekViewEvent(5, "SESSION", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_04));
        events.add(event);
        ...
        event = new WeekViewEvent(7, "SESSION", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_03));
        events.add(event);
        events.add(event);
        ...
        event = new WeekViewEvent(8, "SESSION", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_02));
        events.add(event);
